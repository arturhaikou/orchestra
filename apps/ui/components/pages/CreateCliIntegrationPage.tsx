          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                title="Load available models from GitHub Copilot"
              >
                {isLoadingModels
            ...
            <p className="text-xs text-textMuted">
              Leave as default to let Copilot choose the model. Click Load to fetch available models using your credentials above.
            </p>
          </div>
