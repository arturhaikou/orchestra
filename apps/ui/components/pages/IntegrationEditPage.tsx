...
const IntegrationEditPage: React.FC = () => {
  ...
  } = useIntegrationEditForm(workspaceId, integrationId);
    ...
    return (
      <div className="max-w-3xl mx-auto py-8 px-4">
        <div className="text-center py-20">
          ...
          <h2 className="text-xl font-bold text-text mb-2">Integration not found</h2>
          <p className="text-textMuted mb-6">The integration you're looking for doesn't exist or has been removed.</p>
          <Link
            to={integrationsListPath}
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-primary hover:bg-primaryHover text-white rounded-lg text-sm font-bold transition-all"
          >
    ...
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="bg-surface border border-border rounded-xl shadow-xl shadow-primary/5 overflow-hidden">
        <div className="px-6 py-4 border-b border-border-elevated">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-text to-textMuted bg-clip-text text-transparent">Edit Integration</h1>
          <p className="text-sm text-textMuted mt-0.5">Update integration configuration.</p>
        </div>
        ...
        <form onSubmit={handleSave} className="p-6 space-y-6">
          ...
          <section className="space-y-2">
            ...
            <div className="w-full bg-background border border-border rounded-lg px-3 py-2.5 text-sm text-textMuted">
              {PROVIDER_LABELS[formState.provider] || formState.provider}
            </div>
          ...
          <section className="space-y-1.5">
            ...
            <p className="text-xs text-textMuted">Leave unchanged to keep the existing key. Enter a new value to replace it.</p>
          </section>
