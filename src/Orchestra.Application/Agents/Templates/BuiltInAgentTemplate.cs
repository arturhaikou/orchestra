...
public record BuiltInAgentTemplate(
    ...
    IReadOnlyDictionary<ProviderType, IReadOnlyList<string>>? OptionalProviderToolMethodMap = null,
    IReadOnlyDictionary<string, string>? OptionalProviderToolLabelMap = null);
