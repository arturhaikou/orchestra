...
namespace Orchestra.Infrastructure.Migrations
{
    ...
    [Migration("20260606205125_AddConditionStepSupport")]
    partial class AddConditionStepSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orchestra.Domain.Entities.AgentCliSkill", b =>
                {
                    ...
                    b.HasKey("AgentId", "SkillName");

                    b.HasIndex("AgentId")
                        .HasDatabaseName("IX_AgentCliSkills_AgentId");

                    b.ToTable("AgentCliSkills", (string)null);
                });
            ...
            modelBuilder.Entity("Orchestra.Domain.Entities.WorkflowStepSystemTool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WorkflowStepSystemTools", (string)null);
                });
            ...
            modelBuilder.Entity("Orchestra.Domain.Entities.WorkflowStepSystemTool", b =>
                {
                    b.HasOne("Orchestra.Domain.Entities.WorkflowStep", null)
                        .WithMany()
