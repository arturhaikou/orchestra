...
namespace Orchestra.Infrastructure.Migrations
{
    ...
    [Migration("20260414082531_InitialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orchestra.Domain.Entities.WorkspaceModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_WorkspaceModels_Status");

                    b.HasIndex("WorkspaceId", "ModelName");

                    b.ToTable("WorkspaceModels", null, t =>
                        {
                            t.HasCheckConstraint("CK_WorkspaceModels_PullProgress", "\"PullProgress\" IS NULL OR (\"PullProgress\" >= 0 AND \"PullProgress\" <= 100)");
                        });
                });
