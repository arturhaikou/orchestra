        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    IsAiSummarizationEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsCustomerSatisfactionAnalysisEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    AiSummarizationModelId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CustomerSatisfactionAnalysisModelId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomInstructions = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    ProjectPrinciples = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    ...
                    TemplateIdentifier = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultModelId = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIProviderConfigurations_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TransportType = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ...
                    EncryptedEnvironmentVariables = table.Column<string>(type: "character varying(8000)", maxLength: 8000, nullable: true),
                    ConnectionStatus = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false, defaultValue: "Unknown"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_McpServers_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentMcpTools", x => new { x.AgentId, x.McpServerId, x.ToolName });
                    table.ForeignKey(
                        name: "FK_AgentMcpTools_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentMcpTools_McpServers_McpServerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceClassName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    IntegrationId = table.Column<Guid>(type: "uuid", nullable: true),
                    McpServerId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToolCategories_Integrations_IntegrationId",
                        column: x => x.IntegrationId,
                        principalTable: "Integrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToolCategories_McpServers_McpServerId",
                        column: x => x.McpServerId,
                        principalTable: "McpServers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMcpTool = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    McpToolSchema = table.Column<string>(type: "jsonb", nullable: true),
                    IntegrationId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToolActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToolActions_Integrations_IntegrationId",
                        column: x => x.IntegrationId,
                        principalTable: "Integrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ToolActions_ToolCategories_ToolCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentToolActions", x => new { x.AgentId, x.ToolActionId });
                    table.ForeignKey(
                        name: "FK_AgentToolActions_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentToolActions_ToolActions_ToolActionId",
                        column: x => x.ToolActionId,
                        principalTable: "ToolActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentMcpTools_AgentId",
                table: "AgentMcpTools",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentMcpTools_McpServerId",
                table: "AgentMcpTools",
                column: "McpServerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentToolActions_ToolActionId",
                table: "AgentToolActions",
                column: "ToolActionId");

            migrationBuilder.CreateIndex(
                name: "IX_AIProviderConfigurations_WorkspaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_McpServers_WorkspaceId",
                table: "McpServers",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_McpServers_WorkspaceId_Name",
                table: "McpServers",
                columns: new[] { "WorkspaceId", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_AssignedAgentId_StatusId_Partial",
                table: "Tickets",
                columns: new[] { "AssignedAgentId", "StatusId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_WorkspaceId_IsInternal",
                table: "Tickets",
                columns: new[] { "WorkspaceId", "IsInternal" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_IntegrationId_IsActive",
                table: "ToolActions",
                columns: new[] { "IntegrationId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_IsActive",
                table: "ToolActions",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_IsEnabled",
                table: "ToolActions",
                column: "IsEnabled");

            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_ToolCategoryId",
                table: "ToolActions",
                column: "ToolCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_ToolCategoryId_MethodName",
                table: "ToolActions",
                columns: new[] { "ToolCategoryId", "MethodName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ToolActions_ToolCategoryId_Name",
                table: "ToolActions",
                columns: new[] { "ToolCategoryId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ToolCategories_IntegrationId_Unique",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolCategories_IsActive",
                table: "ToolCategories",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ToolCategories_McpServerId",
                table: "ToolCategories",
                column: "McpServerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolCategories_ProviderType",
                table: "ToolCategories",
                column: "ProviderType");
